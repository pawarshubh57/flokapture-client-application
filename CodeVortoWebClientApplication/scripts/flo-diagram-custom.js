...
(function ($) {
    ...
    // Additional functions depending on parameters...

    this.buildDiagramWithCanvas = function(lstNodes, lstLinks, diagram) {
        diagram.clearAll();
        var nodeMap = [];
        var nodes = lstNodes;
        Array.forEach(nodes,
    ...
    this.downloadDiagramCanvas = function (gDiagram) {
        // var gDiagram = Diagram.find("diagram") || Diagram.find("diagram-workflow");
        // var gDiagram = Diagram.find(canvasId); // || Diagram.find("diagram-workflow");
        var gNodes = [];
        var gLinks = [];
        $.each(gDiagram.nodes, function (i, node) {
            gNodes.push({
