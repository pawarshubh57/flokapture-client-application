...
function fillProjectDropDown() {
    jQuery.ajax({
        type: "GET",
        url: baseAddress + "General/GetEntity?entity=ProjectType",
        success: function (result) {
            $.each(result, function (key, value) {
                $("#ddlProjectType").append("<option value=" + value.Value + ">" + value.Name + "</option>");
            });
...
function fillSolutionDropDown() {
    ...
    jQuery.ajax({
        type: "GET",
        url: baseAddress + "General/GetEntity?entity=SolutionMaster",
        success: function (result) {
            $.each(result, function (key, value) {
                $("#ddlsolutionType").append("<option value=" + value.Value + ">" + value.Name + "</option>");
            });
        }
    });
}
...
function fillLanguageDropDown() {
    ...
    jQuery.ajax({
        type: "GET",
        url: baseAddress + "General/GetEntity?entity=LanguageMaster",
        success: function (result) {
            $.each(result,
                function (key, value) {
                    $("#ddlLanguageType").append("<option value=" + value.Value + ">" + value.Name + "</option>");
                });
        }
    });
};
