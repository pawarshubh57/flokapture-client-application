...
function loadTreeFormatData(projectId, stmtId) {
    ...
    $.get(baseAddress + "StatementRule/GetPseudoCodeDataTreeFormat?projectId=" + projectId + "&stmtId=" + stmtId + "&business=" + chkBusiness + "&pseudo=" + chkpseudo + "&annotate=" + chkAnnotate + "&userId=" + userId,
        function (tData) {
            var secondTab = tData[0].TreeViewListSecondTab;
            var actionWorkflow = tData[0].ActionWorkflows;
            var originEventMethod = actionWorkflow.OriginEventMethod;
...
function firstTabClickEventTreeFormat(projectId, stmtId) {
    $.get(baseAddress + "StatementRule/GetDataForFirstTabTreeFormat?projectId=" + projectId + "&stmtId=" + stmtId,
        function (tData) {
            if (tData !== null) {
...
function annotateStatement123(statementId, graphName, actualStatmentId, graphId) {
    ...
    jQuery.ajax({
        ...
        success: function (result) {
            ...
            $("#txtAnnotateStatement").val(graphName);
