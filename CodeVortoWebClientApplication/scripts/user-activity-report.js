...
$(document).ready(function () {
    ...
    if (option === "1") {
        // $(".breadcrumb").append(" <li><a href='#'>Site Admin</a></li><li class='active'><a href='user_activity_report.html?opt=1'>User Activity Report</a></li>");
                        ...
                        $("#tblUserActivityReport")
                            .ejGrid({
                                ...
                                columns: [
                                    ...
                                    //{ field: "OptionUsed", headerText: "Event Name", width: "18%" },
                                    //{ field: "BriefDescription", headerText: "Description", width: "20%" },
    ...
    if (option === "2") {
        // $(".breadcrumb").append("<li><a href='#'>Inventory</a></li><li class='active'><a href='user_activity_report.html?opt=2'>Entity/Attribute Usage</a></li>");
        document.getElementById("divUserActivity").style.display = "none";
