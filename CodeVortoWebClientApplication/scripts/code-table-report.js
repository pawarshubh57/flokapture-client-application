...
$(document).ready(function () {
    ...
    codeTableReports.getAllActivities().done(function (res) {
        ...
        res.forEach(function (r) {
            r.SrNo = ++srNo;
            // r.Statement = r.Statement.replace(/<</, "&lt;&lt;").replace(/>>/, "&gt;&gt;");
            // r.ControlRecord = r.ControlRecord.replace("FLE ", "");
        });
        $("#codeTableRpt").ejGrid({
            width: "100%",
            dataSource: res,
            ...
            columns: [
                ...
                // { field: "EntityOtherName", headerText: "Entity Other Name", width: "10%" },
...
function exportGrid(tableName) {
    ...
    var excelString = prepareExcelFile(excelTable, "Code Table");
...
var prepareAndDownloadExcel = function (excelFile) {
    ...
    element.setAttribute("download", "CodeTablesReport.xls");
